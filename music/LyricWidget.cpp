...
void LyricWidget::positionChanged1(qint64 length)
{
    m_nCurPos=length;
...
//    file1.seek(0);
//    getByt = file1.readAll();
//    qDebug() <<"lrc"<< getByt.data();
...
//CONVERT_CODE   LyricWidget::KrcDecode2(QFile  &KrcFile, QFile  &LrcFile)
//{
